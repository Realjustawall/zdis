...
const PRESETS: Array<{ id: string; name: string; description: string; theme: CustomTheme }> = [
  ...
  },
  {
    id: 'tokyo',
    name: 'Tokyo night',
    description: 'Electric blue and violet over an inky navy workspace.',
    theme: { ...DEFAULT_CUSTOM_THEME, accent: '#7aa2f7', accentHover: '#9ab8ff', background: '#080b16', rail: '#0d1122', sidebar: '#12172b', panel: '#171d33', elevated: '#202944', input: '#293452', text: '#f0f3ff', muted: '#9aa7c7' },
  },
  {
    id: 'graphite',
    name: 'Graphite mono',
    description: 'Near-black neutral surfaces with quiet silver controls.',
    theme: { ...DEFAULT_CUSTOM_THEME, accent: '#a7b0c0', accentHover: '#c4cad4', background: '#050607', rail: '#090b0e', sidebar: '#0e1115', panel: '#13171c', elevated: '#1b2027', input: '#222934', text: '#f3f5f7', muted: '#929cac' },
  },
  {
    id: 'abyss',
    name: 'Abyss blue',
    description: 'Deep ocean surfaces with crisp cyan highlights.',
    theme: { ...DEFAULT_CUSTOM_THEME, accent: '#38bdf8', accentHover: '#67d1fb', background: '#041019', rail: '#071823', sidebar: '#0b202d', panel: '#0f2938', elevated: '#163747', input: '#1c4354', text: '#effbff', muted: '#94b8c7' },
  },
  {
    id: 'crimson',
    name: 'Crimson noir',
    description: 'Dark charcoal with restrained ruby-red accents.',
    theme: { ...DEFAULT_CUSTOM_THEME, accent: '#fb7185', accentHover: '#ff93a3', background: '#0d0709', rail: '#150b0f', sidebar: '#1c1015', panel: '#24151b', elevated: '#321d25', input: '#40252f', text: '#fff1f3', muted: '#bda0a7' },
  },
  {
    id: 'nord',
    name: 'Nord frost',
    description: 'Cool slate surfaces inspired by polar nights.',
    theme: { ...DEFAULT_CUSTOM_THEME, accent: '#88c0d0', accentHover: '#a3d4df', background: '#090e15', rail: '#0e151f', sidebar: '#141d29', panel: '#1a2532', elevated: '#243241', input: '#2d3d4e', text: '#eceff4', muted: '#a5b4c5' },
  },
  {
    id: 'espresso',
    name: 'Espresso dark',
    description: 'Warm coffee-black panels with amber interaction cues.',
    theme: { ...DEFAULT_CUSTOM_THEME, accent: '#f59e0b', accentHover: '#fbbf24', background: '#0c0907', rail: '#15100c', sidebar: '#1d1611', panel: '#261d16', elevated: '#34271d', input: '#443326', text: '#fff8ed', muted: '#baa994' },
  },
];
