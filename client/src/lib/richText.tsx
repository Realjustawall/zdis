...
const RULES: Rule[] = [
  ...
  },
  {
    ...
    render: (m) => {
      ...
      if (!href) return <bdi dir="ltr">{m[0]}</bdi>;
      return (
        <a href={href} target="_blank" rel="noopener noreferrer nofollow" className="link" dir="ltr">
  ...
  },
  {
    ...
    render: (m, o) => (
      <button type="button" className="mention channel" dir="auto" onClick={() => o.onChannelClick?.(m[1])}>
        #{m[1]}
      </button>
    ),
  },
